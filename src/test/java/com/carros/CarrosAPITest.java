...
public class CarrosAPITest {
	...
	public void testListaPorTipo() {
		assertEquals(10, getCarros("/api/v1/carros/tipo/classicos").getBody());
		assertEquals(10, getCarros("/api/v1/carros/tipo/esportivos").getBody());
		assertEquals(10, getCarros("/api/v1/carros/tipo/luxo").getBody());
	...
	public void TestGetNotFound() {
		ResponseEntity response = getCarro("/api/v1/carros/1111");
